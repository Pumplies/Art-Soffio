  ...
  return (
    ...
    >
      <section className="flex flex-col w-[70%] md:w-[50%] hd:w-[70%] relative hd:pr-[130px]">
        ...
        ></Image>
        <p className="pr-[60px] hd:pr-0 font-[500] text-[12px] md:text-[25px] hd:text-[34px] leading-[16px] md:leading-[35px] hd:leading-[45px] mb-[46px] hd:mb-[87px] mt-[10px] hd:mt-[42px]">
      ...
      <section className="relative w-[50%]">
        <Image
          ...
          width={355}
          height={487}
          className="absolute top-[60px] left-[-60px] md:left-[40px] md:top-[70px] xl:top-[-70px] hd:left-0 hd:top-[-160px] md:w-[255px] md:h-[350px] hd:w-[355px] hd:h-[487px]"
        ></Image>
        <Image
          src={"/certificate.png"}
          alt="certificate"
          width={355}
          height={487}
          className="absolute left-[-20px] top-[65px] md:left-[150px] md:top-[70px] xl:top-[-60px] hd:top-[-170px] hd:left-[156px] rotate-[22deg] md:w-[255px] md:h-[350px] hd:w-[355px] hd:h-[487px]"
        ></Image>
        <Image
          src={"/certificate.png"}
          alt="certificate"
          width={355}
          height={487}
          className="absolute left-[20px] top-[80px] md:left-[260px] md:top-[120px] xl:top-[20px] hd:top-[-50px] hd:left-[300px] rotate-[46deg] md:w-[255px] md:h-[350px] hd:w-[355px] hd:h-[487px]"
        ></Image>
      </section>
    </article>
  );
