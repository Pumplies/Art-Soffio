    ...
    <section className="pt-[73px] md:pt-[150px] hd:pt-[195px] pb-[140px] hd:pb-[208px]">
      ...
      <article className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[45px]">
        ...
        <AcordeonCard
          ...
          text="ART SOFFIO предлагает широкий выбор оттенков и текстур, чтобы каждый клиент мог найти свою палитру оттенков. Это позволяет вам удовлетво-рить запросы самых требова-тельных покупателей."
        />
      </article>
