...
export default function SecondSlide({ isMobile }) {
  return (
    <div className="relative w-full h-full">
          {isMobile ? (
            <Image src={"/slide2-mobile.svg"} height={700} width={1000} priority alt="Слайд для мобильных устройств" className="object-contain w-full h-auto md:h-[650px]"  onDragStart={(e) => e.preventDefault()}/>
          ) : (
