...
export default function Header() {
  ...
  return (
    <>
      <header className="flex justify-between items-center py-[45px] px-[40px] md:px-[138px] bg-[#F3FBFF] w-full fixed top-0 z-50">
        ...
        <Image src="/logo.svg" alt="Art Soffio Logo" width={370} height={70} className="w-[188px] h-[35px] mx-auto md:w-[280px] md:h-[53px] hd:w-[370px] hd:h-[70px] md:mx-0"></Image>
